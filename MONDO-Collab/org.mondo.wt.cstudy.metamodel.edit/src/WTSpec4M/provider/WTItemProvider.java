...
/**
 * This is the item provider adapter for a {@link WTSpec4M.WT} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WTItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.WT__SYS_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.WT__MODEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.WT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_SUBSYSTEMS);
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_INPUTS);
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_OUTPUTS);
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_PARAMS);
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_TIMERS);
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_FAULTS);
			childrenFeatures.add(WTSpec4MPackage.Literals.WT__ITS_VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_SUBSYSTEMS,
				 WTSpec4MFactory.eINSTANCE.createMainSubsystem()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_INPUTS,
				 WTSpec4MFactory.eINSTANCE.createSystemInput()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_OUTPUTS,
				 WTSpec4MFactory.eINSTANCE.createSystemOutput()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_PARAMS,
				 WTSpec4MFactory.eINSTANCE.createSystemParam()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_TIMERS,
				 WTSpec4MFactory.eINSTANCE.createSystemTimer()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_FAULTS,
				 WTSpec4MFactory.eINSTANCE.createSystemFault()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpec4MPackage.Literals.WT__ITS_VARIABLES,
				 WTSpec4MFactory.eINSTANCE.createSystemVariable()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return WTSpec4MEditPlugin.INSTANCE;
	}
