...
/**
 * This is the item provider adapter for a {@link WTSpec4M.CtrlUnit29} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.CTRL_UNIT29__INPUT_IINPUT1,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.CTRL_UNIT29__INPUT_IINPUT2,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.CTRL_UNIT29__FAULT_FFAULT1,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpec4MPackage.Literals.CTRL_UNIT29__BHV_PARAM_BHV_PARAM1,
				 true,
				 false,
				 false,
