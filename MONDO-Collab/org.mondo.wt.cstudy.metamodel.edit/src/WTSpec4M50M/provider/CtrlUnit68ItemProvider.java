...
/**
 * This is the item provider adapter for a {@link WTSpec4M50M.CtrlUnit68} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CtrlUnit68ItemProvider extends wtcItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit68_Input__iInput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit68_Input__iInput1_feature", "_UI_CtrlUnit68_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT68__INPUT_IINPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addInput__iInput2PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit68_Input__iInput2_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit68_Input__iInput2_feature", "_UI_CtrlUnit68_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT68__INPUT_IINPUT2,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addOutput__oOutput1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit68_Output__oOutput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit68_Output__oOutput1_feature", "_UI_CtrlUnit68_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT68__OUTPUT_OOUTPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addBhvParam__BhvParam1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit68_BhvParam__BhvParam1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit68_BhvParam__BhvParam1_feature", "_UI_CtrlUnit68_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT68__BHV_PARAM_BHV_PARAM1,
                 true,
                 false,
                 false,
