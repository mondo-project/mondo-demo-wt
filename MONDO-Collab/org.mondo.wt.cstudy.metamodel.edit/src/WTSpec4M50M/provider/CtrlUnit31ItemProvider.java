...
/**
 * This is the item provider adapter for a {@link WTSpec4M50M.CtrlUnit31} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CtrlUnit31ItemProvider extends wtcItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit31_Input__iInput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit31_Input__iInput1_feature", "_UI_CtrlUnit31_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT31__INPUT_IINPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addOutput__oOutput1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit31_Output__oOutput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit31_Output__oOutput1_feature", "_UI_CtrlUnit31_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT31__OUTPUT_OOUTPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addParameter__pParam1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit31_Parameter__pParam1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit31_Parameter__pParam1_feature", "_UI_CtrlUnit31_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT31__PARAMETER_PPARAM1,
                 true,
                 false,
                 true,
                 null,
