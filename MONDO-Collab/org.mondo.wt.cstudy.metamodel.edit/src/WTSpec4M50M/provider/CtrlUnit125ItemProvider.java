...
/**
 * This is the item provider adapter for a {@link WTSpec4M50M.CtrlUnit125} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit125_Input__iInput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit125_Input__iInput1_feature", "_UI_CtrlUnit125_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT125__INPUT_IINPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addOutput__oOutput1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit125_Output__oOutput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit125_Output__oOutput1_feature", "_UI_CtrlUnit125_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT125__OUTPUT_OOUTPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addParameter__pParam1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit125_Parameter__pParam1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit125_Parameter__pParam1_feature", "_UI_CtrlUnit125_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT125__PARAMETER_PPARAM1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addParameter__pParam2PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit125_Parameter__pParam2_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit125_Parameter__pParam2_feature", "_UI_CtrlUnit125_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT125__PARAMETER_PPARAM2,
                 true,
                 false,
                 true,
                 null,
