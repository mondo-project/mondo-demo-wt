...
/**
 * This is the item provider adapter for a {@link WTSpec4M50M.CtrlUnit102} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CtrlUnit102ItemProvider extends wtcItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit102_Input__iInput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit102_Input__iInput1_feature", "_UI_CtrlUnit102_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT102__INPUT_IINPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addInput__iInput2PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit102_Input__iInput2_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit102_Input__iInput2_feature", "_UI_CtrlUnit102_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT102__INPUT_IINPUT2,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addOutput__oOutput1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit102_Output__oOutput1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit102_Output__oOutput1_feature", "_UI_CtrlUnit102_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT102__OUTPUT_OOUTPUT1,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addFault__fFault1PropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_CtrlUnit102_Fault__fFault1_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit102_Fault__fFault1_feature", "_UI_CtrlUnit102_type"),
                 WTSpec4M50MPackage.Literals.CTRL_UNIT102__FAULT_FFAULT1,
                 true,
                 false,
                 true,
                 null,
