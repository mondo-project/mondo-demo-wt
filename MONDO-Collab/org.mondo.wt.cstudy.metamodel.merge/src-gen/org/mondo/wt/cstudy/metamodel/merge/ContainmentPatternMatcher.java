...
public class ContainmentPatternMatcher extends BaseMatcher<ContainmentPatternMatch> {
  ...
  protected ContainmentPatternMatch tupleToMatch(final Tuple t) {
    try {
    	return ContainmentPatternMatch.newMatch((EObject) t.get(POSITION_PARENT), (EObject) t.get(POSITION_CHILD));
  ...
  protected ContainmentPatternMatch arrayToMatch(final Object[] match) {
    try {
    	return ContainmentPatternMatch.newMatch((EObject) match[POSITION_PARENT], (EObject) match[POSITION_CHILD]);
    } catch(ClassCastException e) {
  ...
  protected ContainmentPatternMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return ContainmentPatternMatch.newMutableMatch((EObject) match[POSITION_PARENT], (EObject) match[POSITION_CHILD]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
