 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit47Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit47Impl#getFault__fFault1 <em>Fault fFault1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CtrlUnit47Impl extends wtcImpl implements CtrlUnit47 {
    ...
    protected EClass eStaticClass() {
        return WTSpec4M50MPackage.Literals.CTRL_UNIT47;
    }
        ...
        if (input__iInput1 != null && input__iInput1.eIsProxy()) {
            ...
            if (input__iInput1 != oldInput__iInput1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT47__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
            }
        }
    ...
    public void setInput__iInput1(WTCInput newInput__iInput1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT47__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
    }
    ...
    public WTCFault getFault__fFault1() {
        if (fault__fFault1 != null && fault__fFault1.eIsProxy()) {
            ...
            if (fault__fFault1 != oldFault__fFault1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT47__FAULT_FFAULT1, oldFault__fFault1, fault__fFault1));
            }
        }
    ...
    public void setFault__fFault1(WTCFault newFault__fFault1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT47__FAULT_FFAULT1, oldFault__fFault1, fault__fFault1));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case WTSpec4M50MPackage.CTRL_UNIT47__INPUT_IINPUT1:
                if (resolve) return getInput__iInput1();
                return basicGetInput__iInput1();
            case WTSpec4M50MPackage.CTRL_UNIT47__FAULT_FFAULT1:
