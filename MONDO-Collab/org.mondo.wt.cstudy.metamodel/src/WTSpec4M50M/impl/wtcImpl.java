 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M50M.impl.wtcImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.wtcImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.wtcImpl#getCycle <em>Cycle</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.wtcImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.wtcImpl#isEnabled <em>Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class wtcImpl extends MinimalEObjectImpl.Container implements wtc {
    ...
    protected EClass eStaticClass() {
        return WTSpec4M50MPackage.Literals.WTC;
    }
    ...
    public void setSysId(String newSysId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.WTC__SYS_ID, oldSysId, sysId));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.WTC__DESCRIPTION, oldDescription, description));
    }
    ...
    public void setCycle(short newCycle) {
        ...
        cycle = newCycle;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.WTC__CYCLE, oldCycle, cycle));
    }
    ...
    public void setPriority(short newPriority) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.WTC__PRIORITY, oldPriority, priority));
    }
    ...
    public void setEnabled(boolean newEnabled) {
        ...
        enabled = newEnabled;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.WTC__ENABLED, oldEnabled, enabled));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case WTSpec4M50MPackage.WTC__SYS_ID:
                return getSysId();
            case WTSpec4M50MPackage.WTC__DESCRIPTION:
                return getDescription();
            case WTSpec4M50MPackage.WTC__CYCLE:
                return getCycle();
            case WTSpec4M50MPackage.WTC__PRIORITY:
                return getPriority();
            case WTSpec4M50MPackage.WTC__ENABLED:
                return isEnabled();
        }
