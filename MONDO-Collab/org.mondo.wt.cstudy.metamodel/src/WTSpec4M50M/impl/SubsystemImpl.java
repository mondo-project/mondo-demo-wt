 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M50M.impl.SubsystemImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.SubsystemImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.SubsystemImpl#getItsWTCs <em>Its WT Cs</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.SubsystemImpl#getItsSubsystems <em>Its Subsystems</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubsystemImpl extends MinimalEObjectImpl.Container implements Subsystem {
    ...
    protected EClass eStaticClass() {
        return WTSpec4M50MPackage.Literals.SUBSYSTEM;
    }
    ...
    public void setSysId(String newSysId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.SUBSYSTEM__SYS_ID, oldSysId, sysId));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.SUBSYSTEM__DESCRIPTION, oldDescription, description));
    }
    ...
    public EList<wtc> getItsWTCs() {
        if (itsWTCs == null) {
            itsWTCs = new EObjectContainmentEList<wtc>(wtc.class, this, WTSpec4M50MPackage.SUBSYSTEM__ITS_WT_CS);
        }
        return itsWTCs;
    }
    ...
    public EList<Subsystem> getItsSubsystems() {
        if (itsSubsystems == null) {
            itsSubsystems = new EObjectContainmentEList<Subsystem>(Subsystem.class, this, WTSpec4M50MPackage.SUBSYSTEM__ITS_SUBSYSTEMS);
        }
