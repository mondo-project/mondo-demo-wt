...
import WTSpec4M50M.CtrlUnit10;
import WTSpec4M50M.CtrlUnit102;
import WTSpec4M50M.CtrlUnit11;
import WTSpec4M50M.CtrlUnit124;
import WTSpec4M50M.CtrlUnit125;
import WTSpec4M50M.CtrlUnit126;
import WTSpec4M50M.CtrlUnit13;
import WTSpec4M50M.CtrlUnit15;
import WTSpec4M50M.CtrlUnit18;
import WTSpec4M50M.CtrlUnit27;
import WTSpec4M50M.CtrlUnit29;
import WTSpec4M50M.CtrlUnit31;
import WTSpec4M50M.CtrlUnit34;
import WTSpec4M50M.CtrlUnit36;
import WTSpec4M50M.CtrlUnit37;
import WTSpec4M50M.CtrlUnit39;
import WTSpec4M50M.CtrlUnit40;
import WTSpec4M50M.CtrlUnit44;
import WTSpec4M50M.CtrlUnit46;
import WTSpec4M50M.CtrlUnit47;
import WTSpec4M50M.CtrlUnit49;
import WTSpec4M50M.CtrlUnit5;
import WTSpec4M50M.CtrlUnit50;
import WTSpec4M50M.CtrlUnit58;
import WTSpec4M50M.CtrlUnit59;
import WTSpec4M50M.CtrlUnit65;
import WTSpec4M50M.CtrlUnit68;
import WTSpec4M50M.CtrlUnit71;
import WTSpec4M50M.CtrlUnit73;
import WTSpec4M50M.CtrlUnit78;
import WTSpec4M50M.CtrlUnit80;
import WTSpec4M50M.CtrlUnit9;
import WTSpec4M50M.CtrlUnit92;
import WTSpec4M50M.CtrlUnit94;
import WTSpec4M50M.MainSubsystem;
import WTSpec4M50M.Subsystem;
import WTSpec4M50M.SystemFault;
import WTSpec4M50M.SystemInput;
import WTSpec4M50M.SystemOutput;
import WTSpec4M50M.SystemParam;
import WTSpec4M50M.SystemTimer;
import WTSpec4M50M.SystemVariable;
 ...
 * @generated
 */
public class WTSpec4M50MPackageImpl extends EPackageImpl implements WTSpec4M50MPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see WTSpec4M50M.WTSpec4M50MPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private WTSpec4M50MPackageImpl() {
        super(eNS_URI, WTSpec4M50MFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link WTSpec4M50MPackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static WTSpec4M50MPackage init() {
        if (isInited) return (WTSpec4M50MPackage)EPackage.Registry.INSTANCE.getEPackage(WTSpec4M50MPackage.eNS_URI);

        // Obtain or create and register package
        WTSpec4M50MPackageImpl theWTSpec4M50MPackage = (WTSpec4M50MPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof WTSpec4M50MPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new WTSpec4M50MPackageImpl());

        isInited = true;

        // Create package meta-data objects
        theWTSpec4M50MPackage.createPackageContents();

        // Initialize created meta-data
        theWTSpec4M50MPackage.initializePackageContents();

        // Mark meta-data to indicate it can't be changed
        theWTSpec4M50MPackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(WTSpec4M50MPackage.eNS_URI, theWTSpec4M50MPackage);
        return theWTSpec4M50MPackage;
    }
     ...
     * @generated
     */
    public WTSpec4M50MFactory getWTSpec4M50MFactory() {
        return (WTSpec4M50MFactory)getEFactoryInstance();
    }
    ...
    public void initializePackageContents() {
        ...
        initEClass(wtEClass, WTSpec4M50M.WT.class, "WT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getWT_SysId(), ecorePackage.getEString(), "sysId", null, 0, 1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWT_Model(), ecorePackage.getEString(), "model", null, 0, 1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWT_Version(), ecorePackage.getEString(), "version", null, 0, 1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsSubsystems(), this.getMainSubsystem(), null, "itsSubsystems", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsInputs(), this.getSystemInput(), null, "itsInputs", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsOutputs(), this.getSystemOutput(), null, "itsOutputs", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsParams(), this.getSystemParam(), null, "itsParams", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsTimers(), this.getSystemTimer(), null, "itsTimers", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsFaults(), this.getSystemFault(), null, "itsFaults", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWT_ItsVariables(), this.getSystemVariable(), null, "itsVariables", null, 0, -1, WTSpec4M50M.WT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
