 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit59Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit59Impl#getOutput__oOutput1 <em>Output oOutput1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CtrlUnit59Impl extends wtcImpl implements CtrlUnit59 {
    ...
    protected EClass eStaticClass() {
        return WTSpec4M50MPackage.Literals.CTRL_UNIT59;
    }
        ...
        if (input__iInput1 != null && input__iInput1.eIsProxy()) {
            ...
            if (input__iInput1 != oldInput__iInput1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT59__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
            }
        }
    ...
    public void setInput__iInput1(WTCInput newInput__iInput1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT59__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
    }
    ...
    public WTCOutput getOutput__oOutput1() {
        if (output__oOutput1 != null && output__oOutput1.eIsProxy()) {
            ...
            if (output__oOutput1 != oldOutput__oOutput1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT59__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
            }
        }
    ...
    public void setOutput__oOutput1(WTCOutput newOutput__oOutput1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT59__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case WTSpec4M50MPackage.CTRL_UNIT59__INPUT_IINPUT1:
                if (resolve) return getInput__iInput1();
                return basicGetInput__iInput1();
            case WTSpec4M50MPackage.CTRL_UNIT59__OUTPUT_OOUTPUT1:
