 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit31Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit31Impl#getOutput__oOutput1 <em>Output oOutput1</em>}</li>
 *   <li>{@link WTSpec4M50M.impl.CtrlUnit31Impl#getParameter__pParam1 <em>Parameter pParam1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CtrlUnit31Impl extends wtcImpl implements CtrlUnit31 {
    ...
    protected EClass eStaticClass() {
        return WTSpec4M50MPackage.Literals.CTRL_UNIT31;
    }
        ...
        if (input__iInput1 != null && input__iInput1.eIsProxy()) {
            ...
            if (input__iInput1 != oldInput__iInput1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT31__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
            }
        }
    ...
    public void setInput__iInput1(WTCInput newInput__iInput1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT31__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
    }
    ...
    public WTCOutput getOutput__oOutput1() {
        if (output__oOutput1 != null && output__oOutput1.eIsProxy()) {
            ...
            if (output__oOutput1 != oldOutput__oOutput1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT31__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
            }
        }
    ...
    public void setOutput__oOutput1(WTCOutput newOutput__oOutput1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT31__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
    }
    ...
    public WTCParam getParameter__pParam1() {
        if (parameter__pParam1 != null && parameter__pParam1.eIsProxy()) {
            ...
            if (parameter__pParam1 != oldParameter__pParam1) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4M50MPackage.CTRL_UNIT31__PARAMETER_PPARAM1, oldParameter__pParam1, parameter__pParam1));
            }
        }
    ...
    public void setParameter__pParam1(WTCParam newParameter__pParam1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4M50MPackage.CTRL_UNIT31__PARAMETER_PPARAM1, oldParameter__pParam1, parameter__pParam1));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case WTSpec4M50MPackage.CTRL_UNIT31__INPUT_IINPUT1:
                if (resolve) return getInput__iInput1();
                return basicGetInput__iInput1();
            case WTSpec4M50MPackage.CTRL_UNIT31__OUTPUT_OOUTPUT1:
                if (resolve) return getOutput__oOutput1();
                return basicGetOutput__oOutput1();
            case WTSpec4M50MPackage.CTRL_UNIT31__PARAMETER_PPARAM1:
