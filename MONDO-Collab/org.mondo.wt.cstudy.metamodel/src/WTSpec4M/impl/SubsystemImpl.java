...
public class SubsystemImpl extends MinimalEObjectImpl.Container implements Subsystem {
	...
	public EList<wtc> getItsWTCs() {
		if (itsWTCs == null) {
			itsWTCs = new EObjectContainmentEList<wtc>(wtc.class, this, WTSpec4MPackage.SUBSYSTEM__ITS_WT_CS);
		}
		return itsWTCs;
	}
	...
	public EList<Subsystem> getItsSubsystems() {
		if (itsSubsystems == null) {
			itsSubsystems = new EObjectContainmentEList<Subsystem>(Subsystem.class, this, WTSpec4MPackage.SUBSYSTEM__ITS_SUBSYSTEMS);
		}
