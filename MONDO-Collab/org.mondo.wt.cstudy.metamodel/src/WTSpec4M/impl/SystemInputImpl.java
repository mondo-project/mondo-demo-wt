 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M.impl.SystemInputImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link WTSpec4M.impl.SystemInputImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemInputImpl extends WTCInputImpl implements SystemInput {
	...
	protected EClass eStaticClass() {
		return WTSpec4MPackage.Literals.SYSTEM_INPUT;
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.SYSTEM_INPUT__SYS_ID, oldSysId, sysId));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.SYSTEM_INPUT__DESCRIPTION, oldDescription, description));
	}
