...
/**
 * Generated pattern matcher API of the es.ikerlan.dse.merge.wt.id2object pattern,
 ...
 * <p>Original source:
 * <code><pre>
 * pattern id2object(eobject : WTElement, id) { 
...
public class Id2objectMatcher extends BaseMatcher<Id2objectMatch> {
   ...
   * 
   */
  public Collection<Id2objectMatch> getAllMatches(final WTElement pEobject, final String pId) {
   ...
   * 
   */
  public Id2objectMatch getOneArbitraryMatch(final WTElement pEobject, final String pId) {
   ...
   * 
   */
  public boolean hasMatch(final WTElement pEobject, final String pId) {
   ...
   * 
   */
  public int countMatches(final WTElement pEobject, final String pId) {
   ...
   * 
   */
  public void forEachMatch(final WTElement pEobject, final String pId, final IMatchProcessor<? super Id2objectMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final WTElement pEobject, final String pId, final IMatchProcessor<? super Id2objectMatch> processor) {
   ...
   * 
   */
  public Id2objectMatch newMatch(final WTElement pEobject, final String pId) {
   ...
   * 
   */
  protected Set<WTElement> rawAccumulateAllValuesOfeobject(final Object[] parameters) {
    Set<WTElement> results = new HashSet<WTElement>();
   ...
   * 
   */
  public Set<WTElement> getAllValuesOfeobject() {
   ...
   * 
   */
  public Set<WTElement> getAllValuesOfeobject(final Id2objectMatch partialMatch) {
   ...
   * 
   */
  public Set<WTElement> getAllValuesOfeobject(final String pId) {
   ...
   * 
   */
  public Set<String> getAllValuesOfid(final WTElement pEobject) {
  ...
  protected Id2objectMatch arrayToMatch(final Object[] match) {
    try {
    	return Id2objectMatch.newMatch((es.ikerlan.WTSpec4M.WTElement) match[POSITION_EOBJECT], (java.lang.String) match[POSITION_ID]);
    } catch(ClassCastException e) {
  ...
  protected Id2objectMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return Id2objectMatch.newMutableMatch((es.ikerlan.WTSpec4M.WTElement) match[POSITION_EOBJECT], (java.lang.String) match[POSITION_ID]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
