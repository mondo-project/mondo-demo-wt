...
/**
 * Pattern-specific match representation of the es.ikerlan.dse.merge.wt.id2object pattern,
...
public abstract class Id2objectMatch extends BasePatternMatch {
  private WTElement fEobject;
  
  private String fId;
  
  private static List<String> parameterNames = makeImmutableList("eobject", "id");
  
  private Id2objectMatch(final WTElement pEobject, final String pId) {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("eobject".equals(parameterName) ) {
    	this.fEobject = (es.ikerlan.WTSpec4M.WTElement) newValue;
    	return true;
    }
  ...
  public void setEobject(final WTElement pEobject) {
    if (!isMutable()) throw new java.lang.UnsupportedOperationException();
    this.fEobject = pEobject;
  }
   ...
   * 
   */
  public static Id2objectMatch newMutableMatch(final WTElement pEobject, final String pId) {
   ...
   * 
   */
  public static Id2objectMatch newMatch(final WTElement pEobject, final String pId) {
    return new Immutable(pEobject, pId);
  }
  
  private static final class Mutable extends Id2objectMatch {
    Mutable(final WTElement pEobject, final String pId) {
      super(pEobject, pId);
    }
  ...
  private static final class Immutable extends Id2objectMatch {
    Immutable(final WTElement pEobject, final String pId) {
      super(pEobject, pId);
    }
