...
public class CollectionInputOutputCreateFileWizard extends Wizard implements INewWizard {
	private CollectionInputOutputCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for CollectionInputOutputCreateFileWizard.
	 */
	public CollectionInputOutputCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new CollectionInputOutputCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		CollectionInputOutput rootObject = WTSpec4MFactoryImpl.eINSTANCE.createCollectionInputOutput();
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("itsInputOutput"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
