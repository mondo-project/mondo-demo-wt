...
public class WTSpec4MItemProviderAdapterFactory extends WTSpec4MAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link WTSpec4M.CollectionInputOutput} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected CollectionInputOutputItemProvider collectionInputOutputItemProvider;

	/**
	 * This creates an adapter for a {@link WTSpec4M.CollectionInputOutput}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createCollectionInputOutputAdapter() {
		if (collectionInputOutputItemProvider == null) {
			collectionInputOutputItemProvider = new CollectionInputOutputItemProvider(this);
		}

		return collectionInputOutputItemProvider;
	}
	...
	public void dispose() {
		...
		if (collectionInputOutputItemProvider != null) collectionInputOutputItemProvider.dispose();
	}
