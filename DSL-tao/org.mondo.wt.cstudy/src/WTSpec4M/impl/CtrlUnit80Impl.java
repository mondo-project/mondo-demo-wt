 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M.impl.CtrlUnit80Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit80Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit80Impl#getInput__iInput3 <em>Input iInput3</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit80Impl#getInput__iInput4 <em>Input iInput4</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit80Impl#getInput__iInput5 <em>Input iInput5</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit80Impl#getOutput__oOutput1 <em>Output oOutput1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CtrlUnit80Impl extends wtcImpl implements CtrlUnit80 {
	...
	protected EClass eStaticClass() {
		return WTSpec4MPackage.Literals.CTRL_UNIT80;
	}
		...
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCInput getInput__iInput3() {
		if (input__iInput3 != null && input__iInput3.eIsProxy()) {
			...
			if (input__iInput3 != oldInput__iInput3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
			}
		}
	...
	public void setInput__iInput3(WTCInput newInput__iInput3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
	}
	...
	public WTCInput getInput__iInput4() {
		if (input__iInput4 != null && input__iInput4.eIsProxy()) {
			...
			if (input__iInput4 != oldInput__iInput4) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT4, oldInput__iInput4, input__iInput4));
			}
		}
	...
	public void setInput__iInput4(WTCInput newInput__iInput4) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT4, oldInput__iInput4, input__iInput4));
	}
	...
	public WTCInput getInput__iInput5() {
		if (input__iInput5 != null && input__iInput5.eIsProxy()) {
			...
			if (input__iInput5 != oldInput__iInput5) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT5, oldInput__iInput5, input__iInput5));
			}
		}
	...
	public void setInput__iInput5(WTCInput newInput__iInput5) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT80__INPUT_IINPUT5, oldInput__iInput5, input__iInput5));
	}
	...
	public WTCOutput getOutput__oOutput1() {
		if (output__oOutput1 != null && output__oOutput1.eIsProxy()) {
			...
			if (output__oOutput1 != oldOutput__oOutput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT80__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
			}
		}
	...
	public void setOutput__oOutput1(WTCOutput newOutput__oOutput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT80__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
	}
