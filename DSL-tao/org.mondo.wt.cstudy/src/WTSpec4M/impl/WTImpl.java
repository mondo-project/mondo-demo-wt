 ...
 *   <li>{@link WTSpec4M.impl.WTImpl#getItsInputOutput <em>Its Input Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WTImpl extends EObjectImpl implements WT {
	/**
	...
	/**
	 * The cached value of the '{@link #getItsInputOutput() <em>Its Input Output</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getItsInputOutput()
	 * @generated
	 * @ordered
	 */
	protected EList<CollectionInputOutput> itsInputOutput;
	...
	public EList<MainSubsystem> getItsSubsystems() {
		if (itsSubsystems == null) {
			itsSubsystems = new EObjectContainmentEList.Resolving<MainSubsystem>(MainSubsystem.class, this, WTSpec4MPackage.WT__ITS_SUBSYSTEMS);
		}
	...
	public EList<SystemParam> getItsParams() {
		if (itsParams == null) {
			itsParams = new EObjectContainmentEList.Resolving<SystemParam>(SystemParam.class, this, WTSpec4MPackage.WT__ITS_PARAMS);
		}
		return itsParams;
	}
	...
	public EList<SystemTimer> getItsTimers() {
		if (itsTimers == null) {
			itsTimers = new EObjectContainmentEList.Resolving<SystemTimer>(SystemTimer.class, this, WTSpec4MPackage.WT__ITS_TIMERS);
		}
		return itsTimers;
	}
	...
	public EList<SystemFault> getItsFaults() {
		if (itsFaults == null) {
			itsFaults = new EObjectContainmentEList.Resolving<SystemFault>(SystemFault.class, this, WTSpec4MPackage.WT__ITS_FAULTS);
		}
		return itsFaults;
	}
	...
	public EList<SystemVariable> getItsVariables() {
		if (itsVariables == null) {
			itsVariables = new EObjectContainmentEList.Resolving<SystemVariable>(SystemVariable.class, this, WTSpec4MPackage.WT__ITS_VARIABLES);
		}
		return itsVariables;
	}
	 ...
	 * @generated
	 */
	public EList<CollectionInputOutput> getItsInputOutput() {
		if (itsInputOutput == null) {
			itsInputOutput = new EObjectContainmentEList.Resolving<CollectionInputOutput>(CollectionInputOutput.class, this, WTSpec4MPackage.WT__ITS_INPUT_OUTPUT);
		}
		return itsInputOutput;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WTSpec4MPackage.WT__ITS_INPUT_OUTPUT:
				return ((InternalEList<?>)getItsInputOutput()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case WTSpec4MPackage.WT__ITS_VARIABLES:
				...
				return;
			case WTSpec4MPackage.WT__ITS_INPUT_OUTPUT:
				getItsInputOutput().clear();
				getItsInputOutput().addAll((Collection<? extends CollectionInputOutput>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case WTSpec4MPackage.WT__ITS_INPUT_OUTPUT:
				return itsInputOutput != null && !itsInputOutput.isEmpty();
		}
