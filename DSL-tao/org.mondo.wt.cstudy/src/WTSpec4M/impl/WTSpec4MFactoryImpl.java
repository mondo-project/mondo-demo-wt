...
public class WTSpec4MFactoryImpl extends EFactoryImpl implements WTSpec4MFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case WTSpec4MPackage.COLLECTION_INPUT_OUTPUT: return createCollectionInputOutput();
			default:
	 ...
	 * @generated
	 */
	public CollectionInputOutput createCollectionInputOutput() {
		CollectionInputOutputImpl collectionInputOutput = new CollectionInputOutputImpl();
		return collectionInputOutput;
	}
