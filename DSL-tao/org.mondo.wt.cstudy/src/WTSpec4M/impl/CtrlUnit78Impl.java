 ...
 * </p>
 * <ul>
 *   <li>{@link WTSpec4M.impl.CtrlUnit78Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit78Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpec4M.impl.CtrlUnit78Impl#getOutput__oOutput1 <em>Output oOutput1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CtrlUnit78Impl extends wtcImpl implements CtrlUnit78 {
	...
	protected EClass eStaticClass() {
		return WTSpec4MPackage.Literals.CTRL_UNIT78;
	}
		...
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT78__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT78__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT78__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT78__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCOutput getOutput__oOutput1() {
		if (output__oOutput1 != null && output__oOutput1.eIsProxy()) {
			...
			if (output__oOutput1 != oldOutput__oOutput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpec4MPackage.CTRL_UNIT78__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
			}
		}
	...
	public void setOutput__oOutput1(WTCOutput newOutput__oOutput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpec4MPackage.CTRL_UNIT78__OUTPUT_OOUTPUT1, oldOutput__oOutput1, output__oOutput1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpec4MPackage.CTRL_UNIT78__INPUT_IINPUT1:
				if (resolve) return getInput__iInput1();
				return basicGetInput__iInput1();
			case WTSpec4MPackage.CTRL_UNIT78__INPUT_IINPUT2:
				if (resolve) return getInput__iInput2();
				return basicGetInput__iInput2();
			case WTSpec4MPackage.CTRL_UNIT78__OUTPUT_OOUTPUT1:
