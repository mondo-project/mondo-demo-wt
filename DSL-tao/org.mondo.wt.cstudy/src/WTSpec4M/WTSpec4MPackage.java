...
public interface WTSpec4MPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WT__ITS_VARIABLES = 7;

	/**
	 * The feature id for the '<em><b>Its Input Output</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WT__ITS_INPUT_OUTPUT = 8;
	...
	/**
	 * The meta object id for the '{@link WTSpec4M.impl.CollectionInputOutputImpl <em>Collection Input Output</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see WTSpec4M.impl.CollectionInputOutputImpl
	 * @see WTSpec4M.impl.WTSpec4MPackageImpl#getCollectionInputOutput()
	 * @generated
	 */
	int COLLECTION_INPUT_OUTPUT = 49;

	/**
	 * The feature id for the '<em><b>Its Input</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COLLECTION_INPUT_OUTPUT__ITS_INPUT = 0;

	/**
	 * The feature id for the '<em><b>Its Output</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COLLECTION_INPUT_OUTPUT__ITS_OUTPUT = 1;
	 ...
	 * @ordered
	 */
	int COLLECTION_INPUT_OUTPUT__SYS_ID = 2;

	/**
	 * The number of structural features of the '<em>Collection Input Output</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COLLECTION_INPUT_OUTPUT_FEATURE_COUNT = 3;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link WTSpec4M.WT#getItsInputOutput <em>Its Input Output</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Its Input Output</em>'.
	 * @see WTSpec4M.WT#getItsInputOutput()
	 * @see #getWT()
	 * @generated
	 */
	EReference getWT_ItsInputOutput();
	...
	/**
	 * Returns the meta object for class '{@link WTSpec4M.CollectionInputOutput <em>Collection Input Output</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Collection Input Output</em>'.
	 * @see WTSpec4M.CollectionInputOutput
	 * @generated
	 */
	EClass getCollectionInputOutput();

	/**
	 * Returns the meta object for the containment reference list '{@link WTSpec4M.CollectionInputOutput#getItsInput <em>Its Input</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Its Input</em>'.
	 * @see WTSpec4M.CollectionInputOutput#getItsInput()
	 * @see #getCollectionInputOutput()
	 * @generated
	 */
	EReference getCollectionInputOutput_ItsInput();

	/**
	 * Returns the meta object for the containment reference list '{@link WTSpec4M.CollectionInputOutput#getItsOutput <em>Its Output</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Its Output</em>'.
	 * @see WTSpec4M.CollectionInputOutput#getItsOutput()
	 * @see #getCollectionInputOutput()
	 * @generated
	 */
	EReference getCollectionInputOutput_ItsOutput();

	/**
	 * Returns the meta object for the attribute '{@link WTSpec4M.CollectionInputOutput#getSysId <em>Sys Id</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Sys Id</em>'.
	 * @see WTSpec4M.CollectionInputOutput#getSysId()
	 * @see #getCollectionInputOutput()
	 * @generated
	 */
	EAttribute getCollectionInputOutput_SysId();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Its Input Output</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WT__ITS_INPUT_OUTPUT = eINSTANCE.getWT_ItsInputOutput();
		...
		/**
		 * The meta object literal for the '{@link WTSpec4M.impl.CollectionInputOutputImpl <em>Collection Input Output</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see WTSpec4M.impl.CollectionInputOutputImpl
		 * @see WTSpec4M.impl.WTSpec4MPackageImpl#getCollectionInputOutput()
		 * @generated
		 */
		EClass COLLECTION_INPUT_OUTPUT = eINSTANCE.getCollectionInputOutput();

		/**
		 * The meta object literal for the '<em><b>Its Input</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference COLLECTION_INPUT_OUTPUT__ITS_INPUT = eINSTANCE.getCollectionInputOutput_ItsInput();

		/**
		 * The meta object literal for the '<em><b>Its Output</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference COLLECTION_INPUT_OUTPUT__ITS_OUTPUT = eINSTANCE.getCollectionInputOutput_ItsOutput();
		 ...
		 * @generated
		 */
		EAttribute COLLECTION_INPUT_OUTPUT__SYS_ID = eINSTANCE.getCollectionInputOutput_SysId();
