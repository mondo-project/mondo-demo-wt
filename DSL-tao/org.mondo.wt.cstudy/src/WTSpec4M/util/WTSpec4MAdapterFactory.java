...
public class WTSpec4MAdapterFactory extends AdapterFactoryImpl {
	...
	protected WTSpec4MSwitch<Adapter> modelSwitch =
		new WTSpec4MSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCollectionInputOutput(CollectionInputOutput object) {
				return createCollectionInputOutputAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link WTSpec4M.CollectionInputOutput <em>Collection Input Output</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCollectionInputOutputAdapter() {
		return null;
	}
