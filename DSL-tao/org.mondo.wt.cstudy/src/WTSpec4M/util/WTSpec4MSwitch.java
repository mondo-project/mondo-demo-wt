...
public class WTSpec4MSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WTSpec4MPackage.COLLECTION_INPUT_OUTPUT: {
				CollectionInputOutput collectionInputOutput = (CollectionInputOutput)theEObject;
				T result = caseCollectionInputOutput(collectionInputOutput);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Collection Input Output</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Collection Input Output</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCollectionInputOutput(CollectionInputOutput object) {
		return null;
	}
