 ...
 *   <li>{@link WTSpec4M.WT#getItsInputOutput <em>Its Input Output</em>}</li>
 * </ul>
 *
...
public interface WT extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Its Input Output</b></em>' containment reference list.
	 * The list contents are of type {@link WTSpec4M.CollectionInputOutput}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Its Input Output</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Its Input Output</em>' containment reference list.
	 * @see WTSpec4M.WTSpec4MPackage#getWT_ItsInputOutput()
	 * @model containment="true" resolveProxies="true"
	 * @generated
	 */
	EList<CollectionInputOutput> getItsInputOutput();
